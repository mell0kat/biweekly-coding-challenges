...
console.log(intcode('1,0,0,0,99')) // 2
console.log(intcode('2,3,0,3,99')) // 2
console.log(intcode('2,4,4,5,99,0')) // 2
console.log(intcode('1,1,1,4,99,5,6,0,99')) // 30
...
const findInputParameters = expectedOutput => {
  // try every combination of input & output between 0 and 99
  for (let i = 0; i < 100; i++) {
    for (let j = 0; j < 100; j++) {
      const instructions = map(puzzleInput.split(','), s => +s)

      /* Modify the array' */
      instructions[1] = i
      instructions[2] = j

      const output = intcode(instructions)
...
console.log(findInputParameters(3562672)) // 1202
console.log(findInputParameters(19690720)) // 8250
