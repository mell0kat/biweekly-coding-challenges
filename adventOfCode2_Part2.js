...
const findInputParamters = (expectedOutput) => {
  ...
  for (let i = 0; i < 100; i++){
    ...
    const output = restoreIntcode(copyOfInput)[0]
...
console.log(findInputParamters(3562672)) // 1202
console.log(findInputParamters(19690720)) // 8250
